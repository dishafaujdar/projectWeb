        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <label className="flex items-center">
                    <input
                        type="checkbox"
                        className="h-4 w-4 text-[#8a5cf6] focus:ring-[#8a5cf6] border-gray-600 rounded bg-[#1a1a3a]"
                    />
                    <span className="ml-2 text-sm text-gray-400">Remember me</span>
                </label>
                <a href="/forgot-password" className="text-sm text-[#8a5cf6] hover:text-[#7c52f4] transition-colors">
                    Forgot password?
                </a>
            </div>
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-[#1a1a3a] text-gray-400">Or continue with</span>
                </div>
            </div>
